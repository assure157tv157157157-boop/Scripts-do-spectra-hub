--[[
    ...
    Enhanced with Red/Black theme, round minimize button, background image support,
    improved UI elements, and image button element.
...
local redzlib = {
  Themes = {
    ...
    -- Red/Black theme (new default)
    RedBlack = {
      ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 0, 0)),      -- deep red
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60, 10, 10)),    -- medium red
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 0, 0))       -- blackish red
      }),
      ["Color Hub 2"] = Color3.fromRGB(30, 10, 10),                     -- dark red background
      ["Color Stroke"] = Color3.fromRGB(80, 20, 20),                    -- red stroke
      ["Color Theme"] = Color3.fromRGB(220, 40, 40),                    -- bright red accent
      ["Color Text"] = Color3.fromRGB(255, 240, 240),                   -- off-white text
      ["Color Dark Text"] = Color3.fromRGB(200, 180, 180)               -- soft gray-red text
    },
    Green = {
      ["Color Hub 1"] = ColorSequence.new({
  ...
  Save = {
    UISize = {434,247},
    TabSize = 160,
    Theme = "RedBlack"                     -- default theme changed to RedBlack
  },
  Settings = {},
  Connection = {},
  Instances = {},
...
AddEle("Button", function(parent, props, ...)
  ...
  New.MouseEnter:Connect(function()
    ...
    TweenService:Create(New, TweenInfo.new(0.2), {BackgroundTransparency = 0.4}):Play()
  end)
  New.MouseLeave:Connect(function()
    TweenService:Create(New, TweenInfo.new(0.3), {BackgroundTransparency = 0}):Play()
  end)
  if args[1] then
...
function redzlib:MakeWindow(Configs)
  ...
  -- New: Background image and transparency support
  ...
  local MainFrame = InsertTheme(Create("ImageButton", ScreenGui, {
    ...
    Name = "Hub",
    Image = BackgroundImage or "",          -- set background image if provided
    ImageTransparency = BackgroundImageTransparency,
    ScaleType = Enum.ScaleType.Crop,        -- optional: could be configurable
  }), "Main")
  ...
  -- Make close button round
  local CloseCorner = Instance.new("UICorner")
  CloseCorner.CornerRadius = UDim.new(0.5, 0)  -- half of size (14/2 = 7)
  ...
  -- Already cloned, so it inherits the round corner
  ...
  function Window:SetBackgroundImage(imageId, transparency)
    ...
    if transparency ~= nil then
      MainFrame.ImageTransparency = transparency
    end
  end
  ...
  function Window:SetTmageBackground(imageId)  -- keep original typo for compatibility
  ...
  function Window:MakeTab(paste, Configs)
    ...
    function Tab:AddToggle(Configs)
      ...
      local function SetToggle(Val)
        ...
        if Default then
          ...
          TweenService:Create(ToggleGlow, TweenInfo.new(0.25), {BackgroundTransparency = 0.5}):Play()
          ToggleGlow.Visible = true
        else
          CreateTween({Toggle, "Position", UDim2.new(0, 0, 0.5), 0.25})
          CreateTween({Toggle, "BackgroundTransparency", 0.8, 0.25})
          CreateTween({Toggle, "AnchorPoint", Vector2.new(0, 0.5), 0.25})
          TweenService:Create(ToggleGlow, TweenInfo.new(0.25), {BackgroundTransparency = 1}):Play()
    ...
    function Tab:AddSlider(Configs)
      ...
      SliderHolder.MouseButton1Down:Connect(function()
        CreateTween({SliderIcon, "Size", UDim2.new(0, 12, 0, 20), 0.2})
        Container.ScrollingEnabled = false
        while UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) do task.wait()
          ControlPos()
        end
        CreateTween({SliderIcon, "Size", UDim2.new(0, 8, 0, 16), 0.2})
    ...
    -- New: AddImageButton - creates a button with an image
    function Tab:AddImageButton(Configs)
      ...
      })Make("Corner", ImageButton, UDim.new(0, 8))Make("Stroke", ImageButton)
