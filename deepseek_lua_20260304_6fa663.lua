...
local MyLibrary = {
    ...
    Tabs = {},
    Icons = (function()
        -- (mesma tabela de ícones, omitida por brevidade)
        return {}
    end)()
}
...
local Connections, Connection = {}, MyLibrary.Connection do
    ...
    function Connection:FireConnection(CoName, ...)
        ...
        for _, Func in pairs(ConnectionList) do task.spawn(Func, ...) end
    end
...
local function VerifyTheme(Theme)
    for name, _ in pairs(MyLibrary.Themes) do if name == Theme then return true end end
end
...
local function Make(Ele, Instance, props, ...) return MyLibrary.Elements[Ele](Instance, props, ...) end
...
AddEle("Button", function(parent, props, ...)
    ...
    New.MouseEnter:Connect(function() CreateTween({ New, "BackgroundTransparency", 0.4, 0.2 }) end)
    New.MouseLeave:Connect(function() CreateTween({ New, "BackgroundTransparency", 0, 0.2 }) end)
...
local function ButtonFrame(Instance, Title, Description, HolderSize, Height)
    Height = Height or 25
    ...
    local Frame = Make("Button", Instance, { Size = UDim2.new(1, 0, 0, Height), AutomaticSize = "Y", Name = "Option" })
...
function MyLibrary:MakeWindow(Configs)
    ...
    local WIcon = Configs.Icon or nil
    local WBackground = Configs.Background or "rbxassetid://107918243025204"
    local WBackgroundTransparency = Configs.BackgroundImageTransparency or 0.2
    ...
    local MainFrame = InsertTheme(Create("ImageButton", ScreenGui, {
        ...
        ImageTransparency = WBackgroundTransparency,
    ...
    local IconLabel
    if WIcon then
        IconLabel = Create("ImageLabel", TopBar, {
    ...
    local Title = InsertTheme(Create("TextLabel", TopBar, {
        Position = UDim2.new(0, (WIcon and 35 or 15), 0.5),
        AnchorPoint = Vector2.new(0, 0.5),
        AutomaticSize = "XY",
        Text = WTitle,
        TextXAlignment = "Left",
    ...
    function Window:AddMinimizeButton(Configs)
        local Size = Configs.Size or UDim2.fromOffset(35, 35)
    ...
    function Window:MakeTab(paste, Configs)
        ...
        function Tab:AddParagraph(Configs)
            ...
            local Height = Configs.Height or 25
            local Frame, LabelFunc = ButtonFrame(Container, PName, PDesc, UDim2.new(1, -20), Height)
            local Paragraph = {}
        ...
        function Tab:AddButton(Configs)
            ...
            local FButton, LabelFunc = ButtonFrame(Container, BName, BDescription, UDim2.new(1, -20), Height)
        ...
        function Tab:AddToggle(Configs)
            ...
            local Button, LabelFunc = ButtonFrame(Container, TName, TDesc, UDim2.new(1, -38), Height)
        ...
        function Tab:AddDropdown(Configs)
            ...
            local Button, LabelFunc = ButtonFrame(Container, DName, DDesc, UDim2.new(1, -180), Height)
            ...
            function Dropdown:Select(Option)
                if type(Option) == "string" then
                    for _, Val in pairs(Options) do if Val.Name == Option then Val.Active() end end
                elseif type(Option) == "number" then
                    for ind, Val in pairs(Options) do if ind == Option then Val.Active() end end
                end
            end
        ...
        function Tab:AddSlider(Configs)
            ...
            local Button, LabelFunc = ButtonFrame(Container, SName, SDesc, UDim2.new(1, -180), Height)
            ...
            function SetSlider(NewValue)
                ...
                local SliderPos = (NewValue - Min * Increase) / ((Max - Min) * Increase)
        ...
        function Tab:AddDiscordInvite(Configs)
            ...
            local Height = Configs.Height or 80
